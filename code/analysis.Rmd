...
# data_hypomania <- read_csv("../data/hypomania - Chrobak et al. 2018/matrix.csv") 
...
#   escalc_jaccard(domain = "Hypomania") 
# 
# res_hypomania <- es_hypomania |>
#   rma_jaccard_three_level(title = "Hypomania scales")
# 
